...
const TEST_CONFIG_DIR = path.join(os.tmpdir(), `brain-dump-test-shorthands-${Date.now()}`);
...
describe('type shorthand commands', () => {
  ...
  it('brain idea creates entry with type idea', () => {
  ...
  it('brain project creates entry with type project', () => {
  ...
  it('brain feature creates entry with type feature', () => {
  ...
  it('brain note creates entry with type note', () => {
  ...
  it('brain ref creates entry with type reference', () => {
